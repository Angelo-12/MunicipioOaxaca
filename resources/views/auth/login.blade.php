  ...
  *:focus {
  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <!-- Login Form -->
      <form method="POST" action="{{route('verificar')}}" class="submit-prevent-form">
        @csrf
        <div class="form-group {{$errors->has('email') ? 'has-error' : '' }}">
            <input type="text" id="email" class="fadeIn second" name="email" 
            placeholder="Correo electrónico" value="{{old('email')}}" maxlength="50">
            <br>
        ...
        <div class="form-group {{$errors->has('password') ? 'has-error' : '' }}">
          ...
          placeholder="Contraseña" autocomplete="off" maxlength="30" >
        ...
        <input type="submit" class="fadeIn fourth submit-prevent-btn" value="Iniciar sesión">
      </form>

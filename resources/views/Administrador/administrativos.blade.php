            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text"  class="form-control" id="caja_busqueda_administrativo" placeholder="Texto a buscar">
                        <button type="submit" onclick="BuscarAdministrativo();" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                    </div>
                </div>
            </div>
